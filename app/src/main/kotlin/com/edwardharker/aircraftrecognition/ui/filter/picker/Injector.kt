...
private fun filterPickerUseCase(): FilterPickerUseCase = RepositoryFilterPickerUseCase(filterRepository(), selectedFilterOptions(), filterOptionsRemover()::removeRedundantFilterOptions)
